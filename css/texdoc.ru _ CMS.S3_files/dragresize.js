/**
* @file dragresize.js
* @brief Allows easily create draggable resizable DIVs
* @version 2.0
*/
/*WARNING! Use util.addEvent() instead*/
...
DragResize.prototype.apply = function(node) {
	...
	util.addEvent(node, 'mousedown', function(e) {
		obj.mouseDown(e)
	});
	...
	util.addEvent(node, 'mousemove', function(e) {
		obj.mouseMove(e)
	});
	...
	util.addEvent(node, 'mouseup', function(e) {
		obj.mouseUp(e)
	});
};
...
DragResize.prototype.mouseDown = function(e) {
	with(this) {
		...
		if (elm.tagName == 'INPUT' || elm.tagName == 'IMG')
			return true;
		var newElement = null;
		var newHandle = null;
...
DragResize.prototype.mouseMove = function(e) {
	with(this) {
		...
		*/
		// This is somewhat less buggy
		// by Ruslan Osmanov
		mouseX = coordinatesController.x;
		mouseY = coordinatesController.y;
