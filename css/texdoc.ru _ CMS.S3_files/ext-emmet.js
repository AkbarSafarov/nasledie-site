        ...
        if (scope === "html" || scope === "smarty") {
            ...
            if (state.substring) {
                if (state.substring(0, 3) == "js-")
                    ...
                    scope = "css";
                else if (state.substring(0, 7) == "smarty-")
                    scope = "smarty";
            }
        }
...
exports.runEmmetCommand = function(editor) {
    try {
        ...
        if (editorProxy.getSyntax() == "smarty")
            return false;
...
exports.isSupportedMode = function(modeId) {
    return modeId && /css|less|scss|sass|stylus|html|smarty|php|twig|ejs/.test(modeId);
};
